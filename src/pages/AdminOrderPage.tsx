...
import { FiSearch, FiEdit2, FiTrash2, FiChevronLeft, FiChevronRight, FiSave, FiX } from 'react-icons/fi';
                      ...
                      <div key={index} className="border-b border-gray-200 pb-4 mb-4 last:border-b-0 last:pb-0 last:mb-0">
                        <div className="flex items-start">
                          ...
                          <div className="ml-4 flex-1">
                            ...
                            {item.dimension && (
                              <p className="text-sm text-gray-500">Dimension: {item.dimension}</p>
                            )}
                            <p className="text-sm text-gray-500">Delivery: {item.deliveryMethod} (${item.deliveryPrice.toFixed(2)})</p>
                          </div>
                        </div>
                      </div>
                    ))}
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex justify-between py-2">
                        ...
                        <span className="text-sm font-medium">{editingOrder.paymentMethod}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex justify-between py-2">
                        ...
                        <span className="text-sm font-medium">${editingOrder.subtotal.toFixed(2)}</span>
                      </div>
                      <div className="flex justify-between py-2">
                        <span className="text-sm text-gray-600">Shipping:</span>
                        <span className="text-sm font-medium">${editingOrder.shipping.toFixed(2)}</span>
                      </div>
                      <div className="flex justify-between py-2">
                        <span className="text-sm text-gray-600">Tax:</span>
                        <span className="text-sm font-medium">${editingOrder.tax.toFixed(2)}</span>
                      </div>
                      <div className="flex justify-between py-2 border-t border-gray-200 mt-2 pt-2">
                        <span className="text-sm font-medium text-gray-900">Total:</span>
                        <span className="text-sm font-medium text-gray-900">${editingOrder.total.toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                </div>
