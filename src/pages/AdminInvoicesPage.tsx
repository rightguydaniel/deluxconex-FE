...
const AdminInvoicesPage = () => {
  ...
  const handleStatusChange = async (
    ...
    try {
      const response = await api.patch(
        `/admin/invoices/${invoiceId}/${newStatus}`
      );
  ...
  const handleEditChange = (field: keyof Invoice, value: any) => {
    ...
    if (["subtotal", "tax", "shipping", "discount"].includes(field)) {
      const subtotal =
        field === "subtotal" ? parseFloat(value) || 0 : editingInvoice.subtotal;
      const tax = field === "tax" ? parseFloat(value) || 0 : editingInvoice.tax;
      const shipping =
        field === "shipping" ? parseFloat(value) || 0 : editingInvoice.shipping;
      const discount =
        field === "discount"
          ? parseFloat(value) || 0
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleEditChange("shipping", e.target.value)
                            }
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            step="0.01"
                            min="0"
                ...
                <div className="mt-6 grid grid-cols-1 gap-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleEditChange("terms", e.target.value)
                      }
                      rows={3}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
